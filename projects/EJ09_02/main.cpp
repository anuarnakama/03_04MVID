...
void render(const Geometry& floor, const Geometry& object, const Geometry& light, const Shader& s_phong, const Shader& s_light,
    ...
    s_phong.set("light.position", camera.getPosition()); //se coloca en la posicion de la camara
    s_phong.set("light.direction", camera.getCameraDirection()); //se le da la direccion de la camara
    ...
    s_phong.set("light.cutOff", glm::cos(glm::radians(10.0f)));
    s_phong.set("light.outerCutOff", glm::cos(glm::radians(20.0f)));
