...
Camera secondCamera(glm::vec3(0.0f, 1.0f, 3.0f), glm::vec3(0, 1, 0), -90, -30);
...
void render(const Geometry& quad, const Geometry& cube, const Shader& s_phong, const Shader& s_fbo,
    ...
    //SECOND PASS
    view = secondCamera.getViewMatrix();
    ...
    s_phong.set("viewPos", secondCamera.getPosition());
    ...
    glScissor(0, 0, Window::instance()->getWidth(), Window::instance()->getHeight());
}
