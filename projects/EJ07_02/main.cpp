...
void render(const Geometry& object, const Geometry& light, const Shader& s_phong, const Shader& s_light) {
    ...
    s_phong.set("ambientStrength", 0.3f); //0.3f
    s_phong.set("lightPos", lightPos);

    s_phong.set("viewPos", camera.getPosition());
    s_phong.set("shininess", 64); //64
    s_phong.set("specularStrength", 0.6f); //0.6f
...
int main(int, char* []) {
    ...
    const Shader s_phong("../projects/EJ07_02/phong.vs", "../projects/EJ07_02/phong.fs");
