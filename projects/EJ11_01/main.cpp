...
void render(const Geometry& floor, const Geometry& object, const Shader& s_phong, const Shader& s_alpha,
    const Texture& t_bricks_albedo, const Texture& t_bricks_specular,
    const Texture& t_wood_albedo, const Texture& t_wood_specular,
    const Texture& t_grass_albedo) {
    ...
    t_wood_albedo.use(s_phong, "material.diffuse", 0);
    t_wood_specular.use(s_phong, "material.specular", 1);
    s_phong.set("material.shininess", 32);
    ...
    t_grass_albedo.use(s_alpha, "material.diffuse", 0);
...
int main(int, char* []) {
    ...
    const Shader s_alpha("../projects/EJ11_01/phong.vs", "../projects/EJ11_01/blinn_alpha.fs");
    ...
    while (window->alive()) {
        ...
        render(quad, cube, s_phong, s_alpha, t_bricks_albedo, t_bricks_specular, t_wood_albedo, t_wood_specular, t_grass_albedo);
        window->frame();
    }
