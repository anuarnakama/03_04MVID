...
void render(const Geometry& object, const Geometry& light, const Shader& s_phong, const Shader& s_light,
    const Texture& t_albedo, const Texture& t_specular, const Texture& t_emisive) {
    ...
    t_emisive.use(s_phong, "material.emisive", 2);
...
int main(int, char* []) {
    ...
    const Texture t_emisive("../assets/textures/EJ08.04_emissive.jpg", Texture::Format::RGB);
