...
//Creación de los vertices 
uint32_t createVertexData(uint32_t* VBO, uint32_t* EBO) {
    //Vertices del hexagono
    float vertices[] = {
        -1.0f, 0.0f, 0.0f, //izquierda base
        -0.5f, 1.0f, 0.0f, //izquierda superior
        0.0f, 0.0f, 0.0f, // central comun
        0.5f, 1.0f, 0.0f, //derecha superior
        1.0f, 0.0f, 0.0f, //derecha base
        0.5f, -1.0f, 0.0f, //derecha inferior
        -0.5f, -1.0f, 0.0f, //inquierda inferior
...
int main(int, char* []) {
    ...
    // En este caso he quitado lo de no pintar las caras traseras
