...
Drawable::Drawable(const Geometry& object, const Material& material)
    : _object(object), _material(material), _isGeometry(true), _isModel(false), _IstextureInside(false) {
}

Drawable::Drawable(const Model& object, const Material& material)
    : _model(object), _material(material), _isModel(true), _isGeometry(false), _IstextureInside(false) {
}

Drawable::Drawable(const Model& object)
    : _model(object), _isModel(true), _isGeometry(false), _IstextureInside(true) {
}
